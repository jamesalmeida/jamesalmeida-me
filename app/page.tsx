      ...
      <main className="flex-grow">
        ...
        <section className="py-16 md:py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <Reveal className="text-center mb-12">
              <p className="text-sm uppercase tracking-[0.3em] text-gray-500 mb-3">Services</p>
            ...
            <div className="grid gap-6 md:grid-cols-3">
              <Reveal className="card-glass rounded-2xl p-6" delay={0.05}>
                <div className="w-12 h-12 rounded-xl bg-primary-900 text-white flex items-center justify-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-primary-900 mb-3">Custom Software Solutions</h3>
              ...
              <Reveal className="card-glass rounded-2xl p-6" delay={0.1}>
                ...
                <h3 className="text-xl font-semibold text-primary-900 mb-3">AI Automation & Integration</h3>
                <p className="text-gray-600">
              ...
              <Reveal className="card-glass rounded-2xl p-6" delay={0.15}>
                ...
                <h3 className="text-xl font-semibold text-primary-900 mb-3">AI Training & Workshops</h3>
                <p className="text-gray-600">
        ...
        <section className="py-16 md:py-20 px-4 sm:px-6 lg:px-8 bg-white/80">
          <div className="max-w-6xl mx-auto grid gap-10 lg:grid-cols-[1.1fr_0.9fr] items-center">
            <Reveal>
              <p className="text-sm uppercase tracking-[0.3em] text-gray-500 mb-3">Why James</p>
            ...
            <Reveal className="card-glass rounded-2xl p-8" delay={0.1}>
              <h3 className="text-xl font-semibold text-primary-900 mb-4">What clients can expect</h3>
              <ul className="space-y-4 text-gray-700">
                <li className="flex items-start gap-3">
                  <span className="mt-1 h-2 w-2 rounded-full bg-primary-900" />
