                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        <a href="mailto:james@almeida.ventures" className="hover:text-primary-500 transition-colors">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        <a href="tel:+16692583337" className="hover:text-primary-500 transition-colors">
                          +1 (669) 258-3337
                        </a>
                      </p>
                    </div>
