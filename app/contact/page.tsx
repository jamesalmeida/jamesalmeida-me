      ...
      <main className="flex-grow">
        ...
        <section className="py-16 md:py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12">
            <Reveal>
              <h2 className="text-3xl font-semibold text-primary-900 mb-6">Send a message</h2>
            ...
            <Reveal className="space-y-8" delay={0.1}>
              <div className="card-glass rounded-2xl p-6">
                <h2 className="text-2xl font-semibold text-primary-900 mb-4">Book a Call</h2>
              ...
              <div className="card-glass rounded-2xl p-6 space-y-6">
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-primary-900 rounded-lg flex items-center justify-center text-white">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      <a href="mailto:james@almeida.ventures" className="hover:text-primary-900 transition-colors">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      <a href="tel:+16692583337" className="hover:text-primary-900 transition-colors">
                        +1 (669) 258-3337
                      </a>
                    </p>
                  </div>
